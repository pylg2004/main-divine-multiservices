...
class BeautyDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final allSales = ref.watch(saleRepositoryProvider).byWorkstation(Workstation.beauty);
    ...
    final services = ref.watch(beautyServicesListProvider);
    ...
    return AppShell(
      title: 'Tableau de bord — Soins & Beauté',
      child: ListView(
